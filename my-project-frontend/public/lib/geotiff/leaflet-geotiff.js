...
L.LeafletGeotiff = L.ImageOverlay.extend({
    ...
    initialize: function (url, options) { 
		...
		//add
		this.options.renderer.options.colorScale = (options.renderer.options.colorScale==undefined) ? 'viridis' : options.renderer.options.colorScale;
        this.options.renderer.options.clampLow = (options.renderer.options.clampLow==undefined) ? true : options.renderer.options.clampLow;
        this.options.renderer.options.clampHigh = (options.renderer.options.clampHigh==undefined) ? true : options.renderer.options.clampHigh;
        this.options.renderer.options.arrowSize = (options.renderer.options.arrowSize==undefined) ? 20 : options.renderer.options.arrowSize;
	...
	setColorScale: function (colorScale) {
        this.options.renderer.options.colorScale = colorScale;
        this._reset();
    },
	...
	_preLoadColorScale: function () {
        ...
        var plot = new plotty.plot({
            ...
            width: 1, height: 1,
            domain: [this.options.renderer.options.displayMin, this.options.renderer.options.displayMax], 
            colorScale: this.options.renderer.options.colorScale,
            clampLow: this.options.renderer.options.clampLow,
            clampHigh: this.options.renderer.options.clampHigh,
            useWebGL: false,
        });
    ...
    _drawImage: function () {
        ...
        if (this.raster.hasOwnProperty('data')) {
			...
			var plot = new plotty.plot({
				...
				domain: [self.options.renderer.options.displayMin, self.options.renderer.options.displayMax], 
				colorScale: this.options.renderer.options.colorScale,
				clampLow: this.options.renderer.options.clampLow,
				clampHigh: this.options.renderer.options.clampHigh,
				canvas: plottyCanvas,
